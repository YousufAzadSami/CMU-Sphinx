...
# Stupid broken RedHat autoconf doesn't do /home/sami-mint/eclipse-workspace/ISYVoiceAnomaly/course-isy-18-speech-recognition-code/CMU_Sphnix/PocketSphinx/sphinxbase-5prealpha
builddir="../.."
sourcedir="../.."
