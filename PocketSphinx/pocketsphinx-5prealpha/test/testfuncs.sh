...
# Stupid broken CMU Facilities autoconf doesn't do /home/sami-mint/eclipse-workspace/ISYVoiceAnomaly/course-isy-18-speech-recognition-code/CMU_Sphnix/PocketSphinx/pocketsphinx-5prealpha
builddir=../".."
sourcedir=../".."
